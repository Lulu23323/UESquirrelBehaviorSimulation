...
typedef uint32 BOID_HANDLE;
static constexpr uint32 INVALID_BOID_HANDLE = 65535;
static constexpr uint32 INVALID_BOID_HANDLE_INDEX = 65535;
static constexpr uint32 MAX_BOIDS = 65535;
static constexpr uint32 TOTAL_CELLS = 5000;

typedef uint32 VOLUME_HANDLE;
static constexpr uint32 INVALID_VOLUME_HANDLE = 65535;
static constexpr uint32 INVALID_VOLUME_HANDLE_INDEX = 65535;
static constexpr uint32 MAX_VOLUMES = 20;

static constexpr uint32 MAX_GROUPS = 16;
static constexpr uint32 MAX_MESHES = 16;
static constexpr uint32 MAX_FLOCKS_CUSTOM_DATA_VALUES = 12;

BOID_HANDLE MakeBoidHandle(uint8 GenerationNumber, uint16 Index);
uint16 BoidHandleExtractIndex(BOID_HANDLE Handle);

VOLUME_HANDLE MakeVolumeHandle(uint8 GenerationNumber, uint16 Index);
uint16 VolumeHandleExtractIndex(VOLUME_HANDLE Handle);
...
public:
	...
	uint32 Handle = INVALID_BOID_HANDLE;
};
...
public:
	uint32 Handle = INVALID_VOLUME_HANDLE;
};
...
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Flocks")
	int32 DefaultNumBoids = 0;
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Flocks")
	int32 MeshIndex = 0;
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Flocks")
	FSpawnTypeSettings DefaultSpawnSettings;
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Flocks")
	FDefaultBoidSettings BoidDefaultSettings;
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Flocks")
	FGroupSettings GroupDefaultSettings;
};